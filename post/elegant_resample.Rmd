...
```{r getdata, eval = TRUE, echo = TRUE, message = FALSE}
...
```{r Rstack,echo = TRUE, eval = TRUE, message = FALSE}
...
```{r gdalwarp, eval=TRUE, echo = TRUE}
